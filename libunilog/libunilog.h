...
/* package universal-logger/src/cgo_bridge */
...
extern GoUintptr UniLog_Init(char* configProfile, char* appName, char* loggerProfile, int logLevel, int useLocalNotifier);
